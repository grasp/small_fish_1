...
def get_macd_array(back_day,data_hash,duration)
...
def buy_get_back_days_macd_array(back_days,data_hash,symbol)

  return [] if data_hash.size ==0 #to avoid 
   current_macd_array=Array.new


   #current_macd_array<<get_macd_array(back_days,data_hash,6)
   #current_macd_array<<get_macd_array(back_days,data_hash,12)

  current_macd_array<<get_macd_array(back_days,data_hash,6)
   current_macd_array<<get_macd_array(back_days,data_hash,12)

   current_macd_array<<get_macd_array(back_days,data_hash,20)
   current_macd_array<<get_macd_array(back_days,data_hash,30)
   current_macd_array<<get_macd_array(back_days,data_hash,60)
   #print  current_macd_array
   return current_macd_array

end

def sell_get_back_days_macd_array(back_days,data_hash,symbol)

  return [] if data_hash.size ==0 #to avoid 
   current_macd_array=Array.new


   current_macd_array<<get_macd_array(back_days,data_hash,5)
   current_macd_array<<get_macd_array(back_days,data_hash,12)
