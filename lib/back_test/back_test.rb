...
if macd_signal["5_days_cross_10_days"] ==true && last_macd_signal["5_days_down_10_days"]==true
#if macd_signal["5_days_cross_10_days"] ==true && macd_signal["10_days_down_20_days"]==true && last_macd_signal["5_days_cross_10_days"]==false
 ...
 # puts "Buy signal"
  ...
  #这个地方是卖点信号
  #止损位10%
  if macd_signal["5_days_down_10_days"]==true || ((last_buy_price.to_f-data_array[back_days][1][0].to_f)/last_buy_price.to_f)<=-0.05
